...
<div className="bg-[#11071F] font-customFont">
  ...
  <div className="hero sectionWrapper2 min-h-[50vh] md:min-h-[90vh] relative" id="hero">
    <div className="text-[12px] md:text-[19px] text-left tracking-[2%]  absolute bottom-[75%] top-[20%] md:bottom-[75%] md:ml-[80px]">
      ...
      <img className="absolute right-[65%] top-[-15%] md:right-[95%] md:bottom-[-250%]" src="https://i.postimg.cc/3N5DBXPy/Arrow.png"/> 
  ...
  <div className="flex flex-col">
    ...
    <div className=" justify-center items-center flex flex-col md:flex-row ">
      ...
      <div className="card cardWrapper w-[42vh] h-[25vh] md:w-[80vh] md:h-[35.5vh]  rounded-b-2xl rounded-t-[5px]" >
        ...
        <div className="w-[42vh] h-[25vh] md:w-[80vh] md:h-[35.5vh]  rounded-b-2xl rounded-t-[5px]" style={{ background: "linear-gradient(110.491deg, #130428 7%, #251043 34%, #38126D 57%, #261045 85%, #190634 100%)" }}>
          <div className="bg-[#4F228D] w-[100%] h-[5px] rounded-t-2xl"></div>
          <div className="flex flex-row items-start">
        ...
        <div className=" w-[42vh] h-[25vh] md:w-[80vh] md:h-[35.5vh]  rounded-b-2xl rounded-t-[5px]" style={{ background: "linear-gradient(110.491deg, #130428 7%, #251043 34%, #38126D 57%, #261045 85%, #190634 100%)" }}>
          ...
          <div className="flex flex-row items-start">
            ...
            <div className="p-[72px] pt-9 pl-5">
              ...
              <p className="text-[10px] lg:text-[9px] xl:text-[15px] text-left tracking-[2%] font-[400] font-[Poppins]">My education includes top grades in computer science and has developed my critical thinking and problem-solving skills through various projects and collaborations.</p>
            </div>
          </div>
        </div>
        <div className="card cardWrapper w-[42vh] h-[25vh] md:w-[80vh] md:h-[35.5vh]  rounded-b-2xl rounded-t-[5px]">
          ...
          <div className="flex flex-row items-start">
            ...
            <div className="p-[72px] pt-9 pl-5">
              ...
              <p className="text-[10px] lg:text-[9px] xl:text-[15px] text-left tracking-[2%] font-[400] font-[Poppins]">My career includes a position at PapillonMedia, where I excelled in project management and fast task execution. Clients have distinguished me for my professionalism.</p>
            </div>
          </div>
        </div>
  </div>
  ...
  <div className="flex  flex-col max-w-[80%] mr-[35%] md:max-w-[50%] md:mr-[20%]">
    ...
    <div className="relative z-0 flex flex-row">
      <div className="card relative z-10 w-[100%] md:w-[80%]">
        <div className="cardWrapper p-3 md:p-10 flex flex-row">
          <p className="text-[9px] md:text-[18px] text-left tracking-[2%] max-w-[100%] text-[#CCD6F6]">
      ...
      <img className="w-[100%] absolute z-0 bottom-[-5%] left-[125%] md:bottom-[-30vh] md:left-[100%] transform -translate-x-1/2" src="https://i.ibb.co/HD9VBQ6/Mask-group.png"/>
    </div>
    <div className="flex flex-row m-5 gap-4 justify-center align-middle items-center  z-0">
    <a href="https://viralclothes.vercel.app/"><GiClick className="text-[20px] md:text-[35px]"  /></a>
    <p className="text-[10px] md:text-[18px] text-left tracking-[2%] max-w-[100%] text-[#CCD6F6]">Demo</p>
    <a href="https://maciejbascik.github.io/SoundSwipe/"><GiClick className="text-[20px] md:text-[35px]"/></a>
    <p className="text-[10px] md:text-[18px] text-left tracking-[2%] max-w-[100%] text-[#CCD6F6]">Github</p>
    </div>
  ...
  <div className="flex  flex-col max-w-[80%] ml-[35%] md:max-w-[50%] md:ml-[20%] my-[10%]">
    ...
    <div className="relative flex flex-row ">
      ...
      <img className="absolute z-0 bottom-[-5%] left-[-25%] md:bottom-[-25vh] md:left-[-10%] transform -translate-x-1/2  w-[100%]" src="https://i.ibb.co/7zF3WJW/Portfolio.png"/>
        </div>
    <div className="flex flex-row m-5 gap-4 justify-center align-middle items-center ml-auto">
      <a href="https://maciejbascik.github.io/SoundSwipe/"><GiClick className="text-[20px] md:text-[35px]" /></a>
      <p className="text-[10px] md:text-[18px] text-left tracking-[2%] max-w-[100%] text-[#CCD6F6]">Demo</p>
      <a href="https://github.com/MaciejBascik/SoundSwipe"><GiClick className="text-[20px] md:text-[35px]"/></a>
      <p className="text-[10px] md:text-[18px] text-left tracking-[2%] max-w-[100%] text-[#CCD6F6]">Github</p>
    </div>
